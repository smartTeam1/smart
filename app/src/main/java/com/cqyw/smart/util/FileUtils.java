...
public class FileUtils {
    ...
    public static String readFdText(String filePath) {
    ...
    public static String createDirectory(String directoryName) {
        ...
        if (!directoryName.equals("")) {
            File path = Environment.getExternalStorageDirectory();
            resultPath = path.toString() + File.separator + directoryName;
            mkDirs(resultPath);
        } 
        return resultPath;
    }
     ...
     * @return
     */
    public static File getSaveFile(String filePath, String fileName) {
        File file = new File(createDirectory(filePath) + File.separator + fileName);
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
